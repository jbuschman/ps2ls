...
";
        ...
        private void modelsListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Asset textureAsset = Program.AssetManager.GetAssetByName(model.TextureStrings[0]);
                MemoryStream textureMemoryStream = textureAsset.Pack.CreateAssetMemoryStream(textureAsset);
